...
//Convenience function so the standard algorithms will work.
...
double operator-(const DataPoint &lhs, const DataPoint &rhs) {
    ...
    //Compute the square of the difference between two doubles
...
//Honestly the operators below should be generated by the compiler...
